 ...
 * @author Feny Yanti
 */
public class ManageInterestApproveBean implements Serializable {
	...
	public List<ManageInterestApproveBean> getManageInterestList() {
		if (this.manageInterestList==null)
			this.manageInterestList = new ArrayList<ManageInterestApproveBean>();
	 ...
	 */
	public void setManageInterestList( List<ManageInterestApproveBean> manageInterestList) {
