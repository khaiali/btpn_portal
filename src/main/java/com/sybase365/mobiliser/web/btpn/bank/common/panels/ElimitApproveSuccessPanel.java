 ...
 */
public class ElimitApproveSuccessPanel extends Panel {
	...
	public ElimitApproveSuccessPanel(String id,
	...
	protected void constructPanel() {
		...
		Button submitButton = new Button("submitButton") {
			...
			public void onSubmit() {
				setResponsePage(ElimitApprovePage.class);
