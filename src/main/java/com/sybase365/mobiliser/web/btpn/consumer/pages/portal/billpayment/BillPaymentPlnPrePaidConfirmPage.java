 ...
 * @author Vikram Gunda
 */
public class BillPaymentPlnPrePaidConfirmPage extends BtpnBaseConsumerPortalSelfCarePage {
	 ...
	 */
	public BillPaymentPlnPrePaidConfirmPage() {
		super();
	...
	private void addSubmitButton(final Form<BillPaymentPage> form) {
		form.add(new Button("btnSubmit") {
			...
			public void onSubmit() {
				...
				if (finalId == null) {
					error(BillPaymentPlnPrePaidConfirmPage.this.getLocalizer().getString("product.required", BillPaymentPlnPrePaidConfirmPage.this));
				} 
