 ...
 */
public class ManageCustomUseCaseFeeSuccessApprovePanel extends Panel {

	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(ManageCustomUseCaseFeeSuccessApprovePanel.class);
	...
	public ManageCustomUseCaseFeeSuccessApprovePanel(final String id, final BtpnBaseBankPortalSelfCarePage basePage,
	...
	private void constructPanel() {
		...
		final Form<ManageCustomUseCaseFeeSuccessApprovePanel> form = new Form<ManageCustomUseCaseFeeSuccessApprovePanel>("ucFeeSucAprForm",
			new CompoundPropertyModel<ManageCustomUseCaseFeeSuccessApprovePanel>(this));
		...
		form.add(new Label("ucFeeBean.payeeFee", ucFeeBean.isPayeeFee() ? BtpnConstants.YES_VALUE : BtpnConstants.NO_VALUE));
		...
		form.add(new AjaxButton("finishButton") {
			...
			protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
				setResponsePage(ManageCustomUseCaseFeeApprovePage.class);
			};
		});
	...
	protected void notificationManageFeesDataView(final WebMarkupContainer dataViewContainer) {
		...
		final String displayTotalItemsText = ManageCustomUseCaseFeeSuccessApprovePanel.this.getLocalizer().getString(
			"fees.totalitems.header", ManageCustomUseCaseFeeSuccessApprovePanel.this);
