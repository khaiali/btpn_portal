 ...
 * @author Vikram Gunda
 */
public class BillPaymentPlnPostPaidStrukPage extends BtpnBaseConsumerPortalSelfCarePage {
	 ...
	 */
	public BillPaymentPlnPostPaidStrukPage() {
		super();
	...
	private void addSubmitButton(final Form<BillPaymentPage> form) {
		form.add(new Button("btnSubmit") {
			...
			public void onSubmit() {
				...
				if (finalId == null) {
					error(BillPaymentPlnPostPaidStrukPage.this.getLocalizer().getString("product.required", BillPaymentPlnPostPaidStrukPage.this));
				} 
