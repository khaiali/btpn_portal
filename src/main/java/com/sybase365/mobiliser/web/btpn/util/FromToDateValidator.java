 ...
 * @author Vikram Gunda
 */
public class FromToDateValidator extends AbstractFormValidator {
	 ...
	 */
	public FromToDateValidator(FormComponent<Date> fromDateComponent, FormComponent<Date> toDateComponent) {
	...
	public void validate(Form<?> form) {
		...
		if (isFromDateExist && isToDateExist && fromDate.after(toDate)) {
			error(fromDateComponent, "todate.after.fromdate");
		}
