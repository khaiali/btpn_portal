...
public class BillPaymentPlnPrePaidAmountPage extends BtpnBaseConsumerPortalSelfCarePage {
	 ...
	 */
	public BillPaymentPlnPrePaidAmountPage() {
		super();
	...
	private void addSubmitButton(final Form<BillPaymentPage> form) {
		form.add(new Button("btnSubmit") {
			...
			public void onSubmit() {
				...
				if (finalId == null) {
					error(BillPaymentPlnPrePaidAmountPage.this.getLocalizer().getString("product.required", BillPaymentPlnPrePaidAmountPage.this));
				} 
