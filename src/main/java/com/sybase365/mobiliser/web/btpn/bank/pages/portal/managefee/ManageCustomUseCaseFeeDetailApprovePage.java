...
import com.sybase365.mobiliser.web.btpn.bank.common.panels.ManageCustomUseCaseFeeDetailApprovePanel;
 ...
 */
public class ManageCustomUseCaseFeeDetailApprovePage extends BtpnBaseBankPortalSelfCarePage {
	
	private static final long serialVersionUID = 1L;
	protected ManageCustomUseCaseFeeBean ucFeeBean;

	public ManageCustomUseCaseFeeDetailApprovePage(ManageCustomUseCaseFeeBean ucFeeBean) {
		super();
	...
	protected void initPageComponent(){
		add(new ManageCustomUseCaseFeeDetailApprovePanel("ucFeeDetAprPanel", this, ucFeeBean));
	}
