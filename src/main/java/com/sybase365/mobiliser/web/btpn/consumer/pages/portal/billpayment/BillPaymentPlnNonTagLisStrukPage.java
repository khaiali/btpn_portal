 ...
 * @author Vikram Gunda
 */
public class BillPaymentPlnNonTagLisStrukPage extends BtpnBaseConsumerPortalSelfCarePage {
	 ...
	 */
	public BillPaymentPlnNonTagLisStrukPage() {
		super();
	...
	private void addSubmitButton(final Form<BillPaymentPage> form) {
		form.add(new Button("btnSubmit") {
			...
			public void onSubmit() {
				...
				if (finalId == null) {
					error(BillPaymentPlnNonTagLisStrukPage.this.getLocalizer().getString("product.required", BillPaymentPlnNonTagLisStrukPage.this));
				} 
