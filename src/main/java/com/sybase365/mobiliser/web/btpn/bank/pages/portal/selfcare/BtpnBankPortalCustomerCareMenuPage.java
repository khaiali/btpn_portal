...
/**
 * @author Sreenivasulu Gandham
 */

public class BtpnBankPortalCustomerCareMenuPage extends BtpnBaseBankPortalPage {
	 ...
	 */
	public BtpnBankPortalCustomerCareMenuPage() {
		super();
	}
	 ...
	 */
	public BtpnBankPortalCustomerCareMenuPage(final PageParameters parameters) {
		super(parameters);
	}
	...
	protected void addSelfCarePageComponents() {
		...
		Label headerLbl = new Label("headerLbl", getLocalizer().getString("customerheadermsg", this));
		add(new BankPortalSearchMenuPanel("customerCareMenu", "customer", this));
		add(headerLbl);
	}
