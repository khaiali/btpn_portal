 ...
 * @author Vikram Gunda
 */
public class BillpaymentPlnPostPaidConfirmPage extends BtpnBaseConsumerPortalSelfCarePage {
	 ...
	 */
	public BillpaymentPlnPostPaidConfirmPage() {
		super();
	...
	private void addSubmitButton(final Form<BillPaymentPage> form) {
		form.add(new Button("btnSubmit") {
			...
			public void onSubmit() {
				...
				if (finalId == null) {
					error(BillpaymentPlnPostPaidConfirmPage.this.getLocalizer().getString("product.required", BillpaymentPlnPostPaidConfirmPage.this));
				} 
