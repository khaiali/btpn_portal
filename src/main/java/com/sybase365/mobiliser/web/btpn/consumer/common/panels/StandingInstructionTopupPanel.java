...
import com.sybase365.mobiliser.web.btpn.consumer.pages.portal.airtimetopup.AirtimeTopupConfirmPage;
...
public class StandingInstructionTopupPanel extends BtpnBaseConsumerPortalSelfCarePage {

	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(StandingInstructionTopupPanel.class);
	...
	public StandingInstructionTopupPanel(String id, AirtimePerformBean topupBean) {
		this(id, null, topupBean);
	}

	public StandingInstructionTopupPanel(String id, AttachmentsPanel attachmentsPanel, AirtimePerformBean airtimeBean) {
	...
	protected void initOwnPageComponents(){
		...
		final Form<StandingInstructionTopupPanel> form = new Form<StandingInstructionTopupPanel>("siTopupForm",
				new CompoundPropertyModel<StandingInstructionTopupPanel>(this));
...
//					isTelePhonaBillPay = (root.getLabel().equals("Handphone") || root.getLabel().equals("Telepon"));
	 ...
	 */
	private void addSubmitButton(final Form<StandingInstructionTopupPanel> form) {
		...
		form.add(new Button("btnSubmit") {
			...
			public void onSubmit() {
				...
				if (finalId == null) {
					error(StandingInstructionTopupPanel.this.getLocalizer().getString("product.required", StandingInstructionTopupPanel.this));
				} 
...
//			param.setOriginal("");
			...
			req.setDesc2(airtimeBean.getProductId());
...
//
//		final Form<StandingInstructionTopupPanel> form = new Form<StandingInstructionTopupPanel>("airTimeTopupForm",
//			new CompoundPropertyModel<StandingInstructionTopupPanel>(this));
//
//		// Add feedback panel for Error Messages
//		form.add(new FeedbackPanel("errorMessages"));
//
//		form.add(new AirtimeTelcoDropdownChoice("topupBean.selectedTelco", false, false).setRequired(true).add(
//			new ErrorIndicator()));
//
...
//			@Override
//			public void onSubmit() {
//				setResponsePage(new AirTimeTopupPhoneNumberPage(topupBean));
//			};
//		});
//
//		add(form);
