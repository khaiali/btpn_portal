 ...
 */
public class ElimitEditSuccessPanel extends Panel {
	...
	public ElimitEditSuccessPanel(String id, BtpnBaseBankPortalSelfCarePage basePage, ElimitBean limitBean) {
		super(id);
	...
	protected void constructPanel() {
		...
		form = new Form<BankPortalCashinDetailsPanel>("limitEditSuccessForm",
		...
		Button submitEditConfirm = new Button("submitButton"){
