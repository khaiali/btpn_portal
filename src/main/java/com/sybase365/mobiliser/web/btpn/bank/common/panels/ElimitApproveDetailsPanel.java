...
import com.sybase365.mobiliser.web.btpn.bank.pages.portal.limit.ElimitApproveConfirmPage;
import com.sybase365.mobiliser.web.btpn.bank.pages.portal.limit.ElimitRejectConfirmPage;
 ...
 */
public class ElimitApproveDetailsPanel extends Panel {
	...
	public ElimitApproveDetailsPanel(String id,
	...
	protected void constructPanel() {
		...
		Button approveButton = new Button("approveButton") {
			...
			public void onSubmit() {
				setResponsePage(new ElimitApproveConfirmPage(limitBean));
		...
		Button rejectButton = new Button("rejectButton") {
			...
			@Override
			public void onSubmit() {
				setResponsePage(new ElimitRejectConfirmPage(limitBean));
