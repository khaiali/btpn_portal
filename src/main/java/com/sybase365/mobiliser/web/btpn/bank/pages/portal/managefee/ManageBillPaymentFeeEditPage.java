...
import com.sybase365.mobiliser.web.btpn.bank.common.panels.ManageBillPaymentFeeEditPanel;
 ...
 * @author Vikram Gunda
 */
public class ManageBillPaymentFeeEditPage extends BtpnBaseBankPortalSelfCarePage {

	/**
	 * Constructor for this page.
	 */
	public ManageBillPaymentFeeEditPage(final ManageBillPaymentFeeBean feeBean) {
		super();
	...
	private void initThisPageComponents(final ManageBillPaymentFeeBean feeBean) {
		add(new ManageBillPaymentFeeEditPanel("manageBillPaymentFeeEditPanel", this,feeBean));
	}
}
