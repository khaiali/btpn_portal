 ...
 * @author Feny Yanti
 */
public class ManageInterestTaxBean implements Serializable {
	...
	private List<ManageInterestTaxBean> manageInterestTaxList;
	 ...
	 */
	public List<ManageInterestTaxBean> getManageInterestTaxList() {
		if (this.manageInterestTaxList==null)
			this.manageInterestTaxList = new ArrayList<ManageInterestTaxBean>();
		return manageInterestTaxList;
	}

	/**
	 * @param manageInterestTaxList the manageInterestTaxList to set
	 */
	public void setManageInterestTaxList( List<ManageInterestTaxBean> manageInterestTaxList) {
