 ...
 * @author Vikram Gunda
 */
public class BillPaymentPlnNonTagLisConfirmPage extends BtpnBaseConsumerPortalSelfCarePage {
	 ...
	 */
	public BillPaymentPlnNonTagLisConfirmPage() {
		super();
	...
	private void addSubmitButton(final Form<BillPaymentPage> form) {
		form.add(new Button("btnSubmit") {
			...
			public void onSubmit() {
				...
				if (finalId == null) {
					error(BillPaymentPlnNonTagLisConfirmPage.this.getLocalizer().getString("product.required", BillPaymentPlnNonTagLisConfirmPage.this));
				} 
