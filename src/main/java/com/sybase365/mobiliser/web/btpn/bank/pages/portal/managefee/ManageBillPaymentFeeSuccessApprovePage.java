 ...
 */
public class ManageBillPaymentFeeSuccessApprovePage extends BtpnBaseBankPortalSelfCarePage {
	...
	public ManageBillPaymentFeeSuccessApprovePage(final ManageBillPaymentFeeBean feeBean) {
		super();
	...
	protected void notificationManageFeesDataView(final WebMarkupContainer dataViewContainer) {
		...
		final String displayTotalItemsText = ManageBillPaymentFeeSuccessApprovePage.this.getLocalizer().getString(
			"fees.totalitems.header", ManageBillPaymentFeeSuccessApprovePage.this);
