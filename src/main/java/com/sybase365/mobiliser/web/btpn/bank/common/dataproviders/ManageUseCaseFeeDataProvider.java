 ...
 */
public class ManageUseCaseFeeDataProvider extends SortableDataProvider<ManageCustomUseCaseFeeBean> {
	...
	public ManageUseCaseFeeDataProvider(String defaultSortproperty){
	 ...
	 */
	private void sortById(List<ManageCustomUseCaseFeeBean> entries, boolean asc) {
		if (asc) {
