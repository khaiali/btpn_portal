 ...
 * @author msw
 */
public class AddPanicPayAlertPanel extends Panel {

    private static final long serialVersionUID = 1L;

    private static final Logger LOG = LoggerFactory
	    .getLogger(AddPanicPayAlertPanel.class);
    ...
    private static final String WICKET_ID_addPanicPayAlertForm = "addPanicPayAlertForm";
    ...
    private Form<AddPanicPayAlertPanel> form;
    ...
    public AddPanicPayAlertPanel(String id, MobiliserBasePage mobBasePage,
	...
	this.form = new Form(WICKET_ID_addPanicPayAlertForm,
		new CompoundPropertyModel<AddPanicPayAlertPanel>(this));
