...
public class KeyValueDropDownChoice<K, V> extends DropDownChoice<K> {

    private static final long serialVersionUID = 1L;

    private final Map<K, V> kvChoices = new HashMap<K, V>();

    public KeyValueDropDownChoice(final String id, IModel<K> model,
    ...
    public KeyValueDropDownChoice(final String id,
	    final List<KeyValue<K, V>> keyValues) {
    ...
    private List<K> getKeys(final List<KeyValue<K, V>> keyValues,
	    final SortProperties sortProperties) {
