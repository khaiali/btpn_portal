 ...
 * @author msw
 */
public class EditPanicPayAlertPanel extends Panel {

    private static final long serialVersionUID = 1L;

    private static final Logger LOG = LoggerFactory
	    .getLogger(EditPanicPayAlertPanel.class);
    ...
    private Form<EditPanicPayAlertPanel> form;
    ...
    public EditPanicPayAlertPanel(String id, MobiliserBasePage mobBasePage,
	...
	this.selectedMessageTypeBean.setId(String.valueOf(AlertsHelper
		.getAlertNotificationMessageTypeId(alertType,
			customerAlert.getAlertNotificationMsgId())));

	form = new Form(WICKET_ID_alertForm,
		new CompoundPropertyModel<EditPanicPayAlertPanel>(this));
