...
public class TransactionsContextReport extends BatchContextReport implements
	IContextReport {

    private static final long serialVersionUID = 1L;

    private static final Logger LOG = LoggerFactory
	    .getLogger(TransactionsContextReport.class);

    private Map<String, IContextReportParameter> contextParameters;

    public TransactionsContextReport(final MobiliserWebSession webSession) {
	...
	// Use Case
	IContextReportParameter useCase = new IContextReportParameter() {
		...
		return Arrays.asList(new KeyValue[] {
			new KeyValue<String, String>("Mobile Funds Transfer",
	...
	this.contextParameters.put(useCase.getName(), useCase);

	// Txn status
	IContextReportParameter txnStatus = new IContextReportParameter() {
	    ...
	    public List<?> getValueList(Component component,
		    ILookupMapUtility lookupMapUtility) {
		return Arrays.asList(new KeyValue[] {
			new KeyValue<String, String>("Success", "Success"),
			new KeyValue<String, String>("Failure", "Failure") });
	    }
	...
	this.contextParameters.put(txnStatus.getName(), txnStatus);
    }
