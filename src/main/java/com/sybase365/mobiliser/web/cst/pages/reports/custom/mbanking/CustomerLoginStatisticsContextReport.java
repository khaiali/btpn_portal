...
public class CustomerLoginStatisticsContextReport extends BatchContextReport
	implements IContextReport {

    private static final long serialVersionUID = 1L;

    private static final Logger LOG = LoggerFactory
	    .getLogger(CustomerLoginStatisticsContextReport.class);

    private Map<String, IContextReportParameter> contextParameters;

    public CustomerLoginStatisticsContextReport(
	...
	return "Customer Login Statistics";
    }
