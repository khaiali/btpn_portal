...
public class EmployeeActivityContextReport extends BatchContextReport implements
	IContextReport {

    private static final long serialVersionUID = 1L;

    private static final Logger LOG = LoggerFactory
	    .getLogger(EmployeeActivityContextReport.class);

    private Map<String, IContextReportParameter> contextParameters;

    public EmployeeActivityContextReport(final MobiliserWebSession webSession) {
	...
	IContextReportParameter activity = new IContextReportParameter() {
		...
		return Arrays.asList(new KeyValue[] {
			new KeyValue<String, String>("All", "All"),
			new KeyValue<String, String>("Add Contact Point",
				"Add Contact Point"),
			new KeyValue<String, String>("Add Mobile Alert",
				"Add Mobile Alert"),
			new KeyValue<String, String>("Add Mobile Device",
				"Add Mobile Device"),
			new KeyValue<String, String>("Add Profile",
				"Add Profile"),
			new KeyValue<String, String>("Add Schedule",
				"Add Schedule"),
			new KeyValue<String, String>("Add Service Package",
				"Add Service Package"),
			new KeyValue<String, String>(
				"Assign User To Service Package",
				"Assign User To Service Package"),
			new KeyValue<String, String>("Delete Contact Point",
				"Delete Contact Point"),
			new KeyValue<String, String>("Delete Mobile Alert",
				"Delete Mobile Alert"),
			new KeyValue<String, String>("Delete Mobile Device",
				"Delete Mobile Device"),
			new KeyValue<String, String>("Delete Profile",
				"Delete Profile"),
			new KeyValue<String, String>("Delete Schedule",
				"Delete Schedule"),
			new KeyValue<String, String>("Delete Service Package",
				"Delete Service Package"),
			new KeyValue<String, String>("Login", "Login"),
			new KeyValue<String, String>("Modify Account",
				"Modify Account"),
			new KeyValue<String, String>(
				"Modify Bank Terms & Conditions",
				"Modify Bank Terms & Conditions"),
			new KeyValue<String, String>(
				"Modify Carrier Terms & Conditions",
				"Modify Carrier Terms & Conditions"),
			new KeyValue<String, String>("Modify Contact Point",
				"Modify Contact Point"),
			new KeyValue<String, String>("Modify Mobile Alert",
				"Modify Mobile Alert"),
			new KeyValue<String, String>("Modify Mobile Device",
				"Modify Mobile Device"),
			new KeyValue<String, String>("Modify Profile",
				"Modify Profile"),
			new KeyValue<String, String>("Modify Schedule",
				"Modify Schedule"),
			new KeyValue<String, String>("Mod Service Package",
				"Mod Service Package"),
			new KeyValue<String, String>(
			...
			new KeyValue<String, String>(
				...
				"Set Service Package Entitlements"),
			new KeyValue<String, String>("SSO Authentication",
				"SSO Authentication") });
	    }
