...
/**
 * BaseAlertPage contain logic to implements help messages , alert types
 * messages and error message for Add and Edit alert.
 * 
 * @author sagraw03
 * 
 */
public class BaseAlertPage extends CustomerCareMenuGroup {
