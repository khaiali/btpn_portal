...
public class CurrentUserLoginContextReport extends BatchContextReport implements
	IContextReport {

    private static final long serialVersionUID = 1L;

    private static final Logger LOG = LoggerFactory
	    .getLogger(CurrentUserLoginContextReport.class);

    private Map<String, IContextReportParameter> contextParameters;

    public CurrentUserLoginContextReport(final MobiliserWebSession webSession) {
