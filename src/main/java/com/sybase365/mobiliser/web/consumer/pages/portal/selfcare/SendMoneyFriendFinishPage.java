...
public class SendMoneyFriendFinishPage extends BaseSelfCarePage {

    private static final long serialVersionUID = 1L;

    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory
	    .getLogger(SendMoneyFriendFinishPage.class);
    ...
    public SendMoneyFriendFinishPage(final TransactionBean tab) {
	super();
	...
	Form<?> form = new Form("sendMoneyFinishForm",
		new CompoundPropertyModel<SendMoneyFriendFinishPage>(this));
    ...
    public void next() {
	LOG.debug("SendMoneyFriendFinishPage.next()");
