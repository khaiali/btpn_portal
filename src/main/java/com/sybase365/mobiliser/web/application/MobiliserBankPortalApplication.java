...
import com.sybase365.mobiliser.web.btpn.application.pages.BankPortalApplicationStartPage;
 ...
 */
public class MobiliserBankPortalApplication extends MobiliserApplication {

	private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(MobiliserBankPortalApplication.class);
	 ...
	 * Constructor
	 */
	public MobiliserBankPortalApplication() {
		VERSION = new Version();
	}
	...
	public Class<? extends WebPage> getApplicationSigninPage() {
		...
		return BankPortalApplicationLoginPage.class;
	}
	...
	public Class<? extends WebPage> getApplicationHomePage() {
		...
		return BankPortalHomePage.class;
	}
	...
	protected void init() {
		...
		mountBookmarkablePage(bankPortalPrefsConfig.getLoginUrlSuffix(), getSignInPageClass());
	...
	protected void onUnauthorizedPage(final Page page) {
		...
		throw new RestartResponseAtInterceptPageException(BankPortalApplicationStartPage.class);
	}
	...
	public class Version {
		...
		private Version() {
			try {
				...
				URL versionUrl = MobiliserBankPortalApplication.class.getResource("version.xml");
