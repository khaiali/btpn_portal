...
import com.sybase365.mobiliser.web.btpn.application.pages.ConsumerPortalApplicationStartPage;
...
/**
 * Application object for your Bank Portal Web application. If you want to run this application without deploying, run
 * the Start class.
 * 
 * @see com.sybase.365.mobiliser.web.Start#main(String[])
 */
public class MobiliserConsumerPortalApplication extends MobiliserApplication {

	private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory
		.getLogger(MobiliserConsumerPortalApplication.class);
	 ...
	 */
	private ConsumerPortalConfiguration consumerPortalPrefsConfig;

	/**
	 * Constructor
	 */
	public MobiliserConsumerPortalApplication() {
		VERSION = new Version();
	}
	...
	public Class<? extends WebPage> getApplicationSigninPage() {
		...
		return ConsumerPortalApplicationLoginPage.class;
	}
	...
	protected void init() {
		...
		// Bank Portal Login url
		mountBookmarkablePage(consumerPortalPrefsConfig.getLoginUrlSuffix(), getSignInPageClass());
		...
		return new WebRequestCycleProcessor() {
			...
			protected Page onRuntimeException(Page page, RuntimeException e) {
				if (e instanceof PageExpiredException) {
					ConsumerPortalApplicationLoginPage loginPage = new ConsumerPortalApplicationLoginPage();
	...
	protected void onUnauthorizedPage(final Page page) {
		...
		LOG.debug("UnauthorizedInstantiationException -> restart response at ConsumerPortalApplicationStartPage");
		throw new RestartResponseAtInterceptPageException(ConsumerPortalApplicationStartPage.class);
	}
	...
	public class Version {
		...
		private Version() {
			try {
				...
				URL versionUrl = MobiliserConsumerPortalApplication.class.getResource("version.xml");
	...
	public ConsumerPortalConfiguration getConsumerPortalPrefsConfig() {
		return consumerPortalPrefsConfig;
	}

	public void setConsumerPortalPrefsConfig(final ConsumerPortalConfiguration consumerPortalPrefsConfig) {
		this.consumerPortalPrefsConfig = consumerPortalPrefsConfig;
	}
